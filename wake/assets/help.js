(() => {
  ...
  const topics = {
    ...
    research_pet: ['YOUR INDEPENDENT RESEARCH PET','WAKE✳︎ chooses small projects about physics, philosophy, psychology, AI, and their connections.','Its status shows whether it is working, waiting, or recovering from trouble.','The pet makes a long-running research process easy to visit and follow.','Could useful software feel alive without claiming that it is alive?'],
    ...
    latest_work: ['SOMETHING TO TAKE AWAY','These are the newest research notebooks WAKE✳︎ has made available.','Read the findings together with their sources and limitations.','Useful output matters more than activity for its own sake.','Could a research pet build a public shelf of steadily improving work?'],
